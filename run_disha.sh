data_type="train-with-soda-val"
load_model='/root/megrez-tmp/model/source/RWKV-x070-World-2.9B-v3-20250211-ctx4096.pth'
proj_dir="/root/megrez-tmp/model/3b-$data_type-disha"
data_file="/root/megrez-tmp/dataset/tcm-rwkv/test/train-with-soda-val"
...
--wandb "RWKV7-L$n_layer-N$n_embd-3b-$data_type-disha-tuning" \
